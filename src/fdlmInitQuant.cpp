...
Rcpp::List initQuant = Rcpp::List::create(Named("ZC0") = ZC0, Named("B0Invb0") = B0Invb0, 
Named("B0Inv") = B0Inv, Named("B1") = B1, Named("ZB1") = ZB1, Named("H0Inv") = H0Inv, 
Named("L0H0Inv") = L0H0Inv);
if(modelOut){
